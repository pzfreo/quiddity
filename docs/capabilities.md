...
| `ThinWallBody` | One body-level constant-wall reading with measured thickness, local original-face pair indices, classified unpaired faces, cut-rim regions, paired-area coverage, and a nested heuristic history hint. |
