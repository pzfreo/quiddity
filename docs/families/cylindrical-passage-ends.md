# Polygonal passages ending on an observed bore

- **Formerly:** ADR 0023, moved here 2026-09-15 as a family record. The number stays citeable;
  [its stub](../adr/0023-observed-cylindrical-passage-ends.md) points here.
- **Modules:** `_cylindrical_passages`
