# Represent planar Passage terminations in the section frame

- **Formerly:** ADR 0016, moved here 2026-09-15 as a family record. The number stays citeable;
  [its stub](../adr/0016-planar-passage-termination-planes.md) points here.
- **Modules:** `passages`, `_section_passages`
