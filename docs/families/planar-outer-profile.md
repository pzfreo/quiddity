# Body-owned planar outer-profile inspection

- **Formerly:** ADR 0025, moved here 2026-09-15 as a family record. The number stays citeable;
  [its stub](../adr/0025-body-owned-planar-outer-profile-inspection.md) points here.
- **Modules:** `_outer_profile_geometry`, `inspection`
