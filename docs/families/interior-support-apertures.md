# Independently proved interior support apertures

- **Formerly:** ADR 0021, moved here 2026-09-15 as a family record. The number stays citeable;
  [its stub](../adr/0021-proved-interior-support-apertures.md) points here.
- **Modules:** `_support_apertures`
