# Observed convex two-plane passage ends

- **Formerly:** ADR 0024, moved here 2026-09-15 as a family record. The number stays citeable;
  [its stub](../adr/0024-observed-convex-plane-envelope-ends.md) points here.
- **Modules:** `_plane_envelope_passages`
