# Unify constant-section recesses in one JSON geometry

- **Formerly:** ADR 0019, moved here 2026-09-15 as a family record. The number stays citeable;
  [its stub](../adr/0019-unified-section-recess-json.md) points here.
- **Modules:** `section_recesses`, `document`

- **Status:** Accepted
- **Date:** 2026-09-04
- **Issues:** #290, #495
- **Prototype:** #496
- **Extension:** [ADR 0020](cylindrical-section-ends.md) proposes explicit
