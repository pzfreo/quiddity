...
MODULE_SEAM_EDGES = {
    ...
    "countersinks": {"_candidates", "_claims", "_definitions", "_geometry", "_record", "_typing"},
    "fillets": {
        "_adjacency",
        "_bevel",
        "_candidates",
...
ARC_READER_SITES = {
    ...
    **{
    ...
    "src/quiddity/_section_recess_geometry:_one_mixed_candidate:arc:1": ("exact-nonsmooth"),
    "src/quiddity/_section_recess_geometry:_one_mixed_candidate:arc:2": ("legacy-contract"),
    "src/quiddity/_entry_treatments:prove_entry_treatments:arc:1": ("legacy-contract"),
    "src/quiddity/_entry_treatments:prove_entry_treatments:arc:2": ("exact-nonsmooth"),
    ...
    "src/quiddity/_plane_envelope_passages:_prove:arc:1": "exact-nonsmooth",
    "src/quiddity/_plane_envelope_passages:_prove:arc:2": "exact-nonsmooth",
    "src/quiddity/_plane_envelope_passages:_prove:arc:3": "exact-nonsmooth",
    "src/quiddity/_plane_envelope_passages:plane_envelope_passage_proofs:arc:1": "exact-nonsmooth",
    "src/quiddity/_plane_envelope_passages:plane_envelope_passage_proofs:arc:2": "exact-nonsmooth",
    "src/quiddity/_cylindrical_passages:cylindrical_passage_proofs:arc:1": "exact-nonsmooth",
    "src/quiddity/_cylindrical_passages:cylindrical_passage_proofs:arc:2": "exact-nonsmooth",
    "src/quiddity/_cylindrical_passages:cylindrical_passage_proofs:arc:3": "exact-nonsmooth",
